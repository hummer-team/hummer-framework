package com.hummer.yug.user.plugin.configuration;

import com.hummer.yug.user.plugin.filter.RequestContextFilter;
import com.hummer.yug.user.plugin.interceptor.AuthorityInterceptor;
...
public class UserInterceptorConfiguration implements WebMvcConfigurer {
    ...
    @Bean
    public FilterRegistrationBean<RequestContextFilter> yugContextHolderBean() {
